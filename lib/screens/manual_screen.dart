...
class _GestureCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const ManualCard(
      ...
      rows: [
        ManualRow('แตะการ์ด', 'เปิดหน้ารายละเอียดเพื่อดูและแก้ไข'),
        ManualRow('แตะรูปดินสอ', 'เปิดหน้าเดียวกับการแตะการ์ด'),
        ManualRow('แตะดาว', 'สลับเข้า-ออกรายการโปรด'),
        ManualRow(
          'กดค้าง',
          'เปิดเมนูคัดลอกเบอร์ อีเมล ข้อมูลทั้งหมด หรือเข้าโหมดเลือกหลายรายการ',
        ),
        ManualRow(
          'ปุ่มลบอยู่ที่ไหน',
          'อยู่มุมขวาบนของหน้ารายละเอียด ไม่ได้อยู่บนการ์ด '
              'เพื่อไม่ให้เผลอกดตอนเลื่อนดูรายชื่อ',
        ),
      ],
      note: 'ลบผิดคนกดปุ่ม "เลิกทำ" ในแถบข้อความด้านล่างได้ทันที '
          'รายชื่อจะกลับมาเหมือนเดิม แต่ต้องกดก่อนแถบหายไป',
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return const ManualCard(
      ...
      rows: [
        ManualRow(
          'เข้าโหมด',
          'กดปุ่มติ๊กถูกบนแถบด้านบน หรือกดการ์ดค้างแล้วเลือกเลือกหลายรายการ',
        ),
        ManualRow('เลือก', 'แตะการ์ดเพื่อติ๊ก แตะซ้ำเพื่อเอาออก'),
        ManualRow('เลือกทั้งหมด', 'ปุ่มบนแถบด้านบน เลือกเฉพาะที่แสดงอยู่ตอนนั้น'),
        ManualRow('คัดลอก', 'ได้ข้อความของทุกคนที่เลือกไว้ในครั้งเดียว'),
        ManualRow('ลบ', 'ลบพร้อมกันได้ แต่ถามยืนยันเสมอ และมีปุ่มเลิกทำให้'),
        ManualRow('ออกจากโหมด', 'กดกากบาทมุมซ้ายบน หรือเอาออกจนไม่เหลือใครที่เลือก'),
      ],
      note: 'ใช้ร่วมกับการกรองได้ เช่น กรองกลุ่มที่ทำงานก่อน '
          'แล้วค่อยกดเลือกทั้งหมดเพื่อคัดลอกเฉพาะคนในกลุ่มนั้น',
    );
  }
}
